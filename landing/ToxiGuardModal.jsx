...
export default function ToxiGuardModal({ open, onClose }) {
  const { lang } = useLang();
  const data = getModalData('Toxi-Guard', lang);
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                >
                  <img
                    src="https://media.base44.com/images/public/69fe23b93c8a4ad0ed092450/db4f225b2_image.png"
                    alt="Toxi-Guard product"
