      ...
      {open && (
        ...
        >
          <motion.div
            ...
            style={{
              background: 'linear-gradient(145deg, rgba(28,18,8,0.97) 0%, rgba(18,10,5,0.99) 100%)',
              border: '1px solid rgba(251,146,60,0.3)',
              boxShadow: '0 0 60px rgba(251,146,60,0.12), 0 40px 80px rgba(0,0,0,0.7)',
            }}
          >
            {/* Header */}
            <div
            ...
            >
              <div>
                <div className="font-orbitron text-lg font-bold text-white tracking-[3px]">
                  Metavolin <span style={{ color: '#fb923c' }}>Herbal®</span>
                </div>
                <div className="font-mono text-[9px] tracking-[3px] mt-0.5" style={{ color: 'rgba(251,146,60,0.55)' }}>
                  XVET · HEPATOPROTECTIVE BOTANICAL COMPLEX
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <div
                  ...
                  style={{ background: 'rgba(255,255,255,0.96)', border: '1px solid rgba(251,146,60,0.25)' }}
                >
                  <img
                    src="https://media.base44.com/images/public/69fe23b93c8a4ad0ed092450/03726c011_image.png"
                    alt="Metavolin Herbal® product"
