...
import { getModalData } from '@/lib/productModalsI18n';

export default function MouldGuardDiamondModal({ open, onClose }) {
  const { lang } = useLang();
  const data = getModalData('Mould Guard Diamond', lang);
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          >
            ...
            >
              <div>
               <div className="font-orbitron text-lg font-bold text-white tracking-[3px]">
                 {data.title} <span style={{ color: '#f87171' }}>{data.titleHighlight}</span>
               </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                >
                  <img
                    src="https://media.base44.com/images/public/69fe23b93c8a4ad0ed092450/ea33fe331_image.png"
                    alt="Mould Guard Diamond product"
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-mono text-[10px] tracking-[4px] mb-1" style={{ color: 'rgba(248,113,113,0.6)' }}>{data.packaging}</div>
