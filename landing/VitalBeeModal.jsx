        ...
        >
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 0 60px rgba(200,144,16,0.12), 0 40px 80px rgba(0,0,0,0.7)',
            }}
          >
            {/* Header */}
            <div
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="flex flex-wrap gap-2">
                {tags.map(tag => (
                  <span
                    ...
                    style={{
                      background: 'rgba(200,144,16,0.12)',
                      border: '1px solid rgba(200,144,16,0.35)',
                      color: '#C89010',
                    }}
                  >
                    {tag}
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <div
                  ...
                  style={{ background: 'rgba(255,255,255,0.96)', border: '1px solid rgba(200,144,16,0.25)' }}
                >
                  <img
                    src="https://media.base44.com/images/public/69fe23b93c8a4ad0ed092450/fb4a044a1_image.png"
                    alt="Vital Bee product"
              ...
              <div
                ...
                style={{
                  background: 'rgba(200,144,16,0.06)',
